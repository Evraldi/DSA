...
# Create an instance of CircularSinglyLinkedList
...
print(cll.search(25))  # Output: False
...
cll.display()  # Output: 5 -> 20 -> 25 -> 30 -> HEAD

# Get the length of the list
print(cll.length())  # Output: 4
...
print(cll)  # Output: 5 -> 20 -> 25 -> 30 -> HEAD
